...
The essay also details the method: Claude Code became the primary development tool after October 2025, and the post walks through what a human-plus-agent workflow looks like when the output has to be verified against real hardware behavior rather than taken on faith.
