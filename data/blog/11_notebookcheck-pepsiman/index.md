...
tags: []
featured: true
desc: "Notebookcheck reports on Pepsiman in the browser: the 1999 cult classic recompiled to WebAssembly and running at 60 FPS."
date: "2026-07-28"
venue: "Notebookcheck"
layout: "article"
...
Independent coverage from Notebookcheck, written by Rahim Amir Noorali. This is outside reporting on a community project, distinct from the team's own posts, and it covers an unusual PSXRecomp derivative: a static recompilation of Pepsiman that runs natively in the browser.
...
As a demonstration of what static recompilation output can compile to, this is the piece to point at. The same pipeline that produces native executables produced a web target, because the result is portable C rather than a game running inside a general-purpose console emulator.

Related: [Pepsiman](/games/pepsiman) on [PlayStation](/hardware/playstation).
