...
The most recent essay from the team argues that recompilation and decompilation are not rivals. They are layers of the same preservation strategy. A recomp gets a game running natively now; disassembly annotations then make that output progressively more source-like.
