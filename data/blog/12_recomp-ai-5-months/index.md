...
Five months into the project, this retrospective takes stock of both the games and the tooling. The AI side of the workflow had moved from Claude Opus 4.6 to the newer Fable and Sol models, and the essay reflects on what changed in practice as the models improved underneath the same static recompilation pipeline.
