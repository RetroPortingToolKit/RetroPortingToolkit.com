...
Yes, as a playable alpha. The current release is v0.0.2-alpha (2026-08-01), with a Windows package and a Linux AppImage on the GitHub releases page. The game is built from a dump you provide: your Mega Man X5 (USA) disc image. A bundled open-source BIOS boots it out of the box. It plays from boot through the opening and into stages, but a full playthrough has not been verified on this build.

## What the recomp adds

- Experimental 16:9 widescreen as a default-off mod: it widens the 2D background window along with enemy activation and culling, so you genuinely see more, not a stretched picture. Authentic 4:3 remains the default.
- Frame interpolation as a second default-off mod, at your display's refresh rate or a fixed rate from 90 through 240. It is presentation only: game logic, timers, and audio keep their stock cadence.
