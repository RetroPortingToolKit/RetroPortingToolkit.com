...
Yes, and it is believed fully playable. A v1.1.0 Windows x64 build (2026-04-07) is on [GitHub Releases](https://github.com/mstan/YoshiNESRecomp/releases), with an experimental Linux AppImage alongside; it is built from a dump you provide (USA version). Both single-player puzzle modes, two-player versus, and the attract demo all run end to end, with both controller ports working. Audio is still basic while full sound mixing lands in the framework.
