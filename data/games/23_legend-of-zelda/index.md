...
The Legend of Zelda is one of the ten commercial titles supported by [NESRecomp](/hardware/nes), maintained by the core team. It shipped v1.7.0 on 2026-06-19, and alongside it a separate v1.7.0-hd build labeled "Zelda Remastered HD (EXPERIMENTAL)".
