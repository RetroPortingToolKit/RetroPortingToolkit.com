...
A Windows package is on the GitHub releases page with a SHA-256 checksum beside it. It runs from dumps you provide: pick your Dragon Ball Z: The Legacy of Goku (USA) ROM and a retail GBA BIOS in the launcher the first time, and it remembers them afterwards.
