...
The Mega Man Zero games are notoriously cramped by the GBA's 3:2 screen, and the collection re-releases never addressed it. This [GBARecomp](/hardware/game-boy-advance) project takes the problem on directly. It is the consumer repository for the Zero series, with support arriving across the games, currently at v0.0.3 (2026-07-17).
