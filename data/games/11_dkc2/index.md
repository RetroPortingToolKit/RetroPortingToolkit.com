...
Very early alpha. The first and so far only release, v0.0.1 (2026-07-20), is public for Windows, and the bring-up is underway; expectations should match the version number. An SDL2 host in the source tree is the foundation for future Linux and macOS support, but Windows is the only accepted release platform today. It is built from a dump you provide: the launcher asks for your North American v1.0 ROM and verifies it by checksum.
