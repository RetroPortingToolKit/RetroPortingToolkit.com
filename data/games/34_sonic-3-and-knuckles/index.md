...
Sonic 3 & Knuckles is one of the released titles on [SegaGenesisRecomp](/hardware/sega-genesis), maintained by the core team. The current release is v0.3.0 (2026-06-17), the one that introduced a pre-boot launcher UI.
