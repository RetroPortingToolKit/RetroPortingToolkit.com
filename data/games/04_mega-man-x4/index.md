...
- A period-correct controller quirk handled for you: X4 shipped before the DualShock existed and rejects analog pads outright, so the runtime presents a plain digital pad. Keyboards and modern gamepads both work.
