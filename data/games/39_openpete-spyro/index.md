...
featured: true
desc: "Spyro glides onto PC: a native port built from a fan decompilation, with PSXRecomp covering the functions the decomp has not reached."
year: "2026"
...
group: "Community"
links:
  - { label: "openpete.com", href: "https://openpete.com" }
...
OpenPete is a community-built native PC port of Spyro the Dragon (NTSC-U), released at v0.1.3 for Windows with Linux and macOS planned. The trick is in the hybrid: altro50's unfinished Spyro decompilation provides the hand-written code, [PSXRecomp](/hardware/playstation) covers the functions that have not been decompiled, and SoapyMan's Psycross supplies the platform layer. openpete.com explicitly credits psxrecomp in its "Built on" section.
