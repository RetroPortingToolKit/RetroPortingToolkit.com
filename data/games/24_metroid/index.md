...
An experimental first-person Voxel 3D mode in the launcher's Mods screen. The camera follows Samus, Left and Right steer her heading, and holding Up smoothly raises the view along the near-vertical shot path while the lens widens so overhead enemies and her shots stay visible.
