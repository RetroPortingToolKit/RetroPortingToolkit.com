...
Only symbol metadata, function names, addresses, and sizes, from the pret/pokeruby decompilation enters the repo. None of its C source or build output does, and the ROM is never redistributed.
