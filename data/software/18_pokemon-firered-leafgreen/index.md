...
tags: ["Dual targets"]
featured: false
desc: "Both Gen 1 remakes recompiled from one repository as separate native targets."
year: "2026"
status: "Alpha"
provenance: "core"
...
Pokemon FireRed and LeafGreen share a single [GBARecomp](/hardware/game-boy-advance) repository that builds each game as its own separate native target, currently at v0.0.3 (2026-07-17).
