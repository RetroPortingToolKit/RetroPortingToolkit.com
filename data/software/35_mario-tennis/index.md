...
tags: []
featured: false
desc: "The Virtual Boy framework's first and only title, running at correct play speed as a tech demo."
year: "2026"
status: "Tech demo"
provenance: "core"
...
Mario's Tennis is the first and so far only commercial title on [vbrecomp](/hardware/virtual-boy), the Virtual Boy static recompiler maintained by the core team. The current release is v0.2.0 (2026-06-29), an accuracy release that brought the game to correct play speed.
