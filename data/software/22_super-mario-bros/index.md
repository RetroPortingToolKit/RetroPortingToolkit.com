...
featured: true
desc: "A released NESRecomp title with character replacement mods, an experimental widescreen mod, and a first-person Voxel 3D mode."
year: "2026"
status: "Released"
provenance: "core"
platform: "nes"
...
Super Mario Bros. is one of the ten commercial titles supported by [NESRecomp](/hardware/nes), maintained by the core team, and it has reached a full release at v1.8.0 (2026-08-14). It is a Mapper 0 cartridge, the simplest of the mapper families the framework covers.
