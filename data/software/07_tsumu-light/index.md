...
featured: true
desc: "A Japan-only PlayStation puzzle game with an original English fan translation applied at runtime, no ROM patching."
year: "2026"
status: "Alpha"
provenance: "core"
...
Tsumu Light is a Japanese PlayStation puzzle game that was never released outside Japan. This [PSXRecomp](/hardware/playstation) project, currently at v0.0.2 (2026-07-10), pairs the recompilation with an original English fan translation of a game that never left Japan.
